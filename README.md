...
The data is describe primarily in 1 paper (the first in the list below), but there are several additional works:
...
The data is included in two main formats (each in a self contained
tar.gz file) or in the appropriate directory. 
